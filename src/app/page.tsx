  ...
  return (
    <>
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                {[
                  ...
                  <div key={title} className="glass-dark-tile rounded-xl p-4">
      ...
      <section id="products" className="section-shell scroll-mt-24 pb-16 sm:pb-24">
        <div className="flex flex-col gap-5 border-b border-white/60 pb-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-ink/60">
              {loading ? "Loading the catalogueÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¦" : `${visibleProducts.length} product${visibleProducts.length === 1 ? "" : "s"} available`}
            </p>
          </div>
